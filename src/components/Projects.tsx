...
const projects = [
  ...
  },
  {
    ...
    description: "Analytics dashboard for tracking portfolio performance with beautiful visualizations",
    tags: ["Next.js", "TypeScript", "Chart.js", "Tailwind"],
    gradient: "from-purple-500/20 to-pink-500/20"
  },
  {
    title: "Social Media App",
    description: "Real-time social platform with messaging, feeds, and content sharing",
